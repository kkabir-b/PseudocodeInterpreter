...
KEYWORDS = [
'AND',"OR","NOT","IF","ELSE","THEN","FOR","WHILE","DO","STEP","TO","REPEAT","UNTIL"
]
...
class Parser:
    ...
    def comp_expr(self):
        ...
        tok = self.current_tok
        if res.error: return res.failure(InvalidSyntaxError(tok.pos_start,tok.pos_end,"Expected int,real, '+', '-', or '(','NOT'"))
